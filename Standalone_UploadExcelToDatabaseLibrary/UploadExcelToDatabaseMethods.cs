...
namespace Standalone_UploadExcelToDatabaseLibrary
{
    ...
    public class UploadExcelToDatabaseMethods
    {
        ...
        /// <param name="tableName"></param>
        /// <returns>String with "Success" or the error message</returns>
        public string standaloneUploadFileToDatabaseNoHeaders(string filePath, string databaseConnectionString, string tableName)
        {
            string excelSheetName = getExcelActiveSheetName(filePath);
        ...
        /// <param name="tableName"></param>
        /// <returns>String with "Success" or the error message</returns>
        public string standaloneUploadFileToDatabaseNoHeaders(string filePath, string databaseConnectionString, string tableName, string excelSheetName)
        {
